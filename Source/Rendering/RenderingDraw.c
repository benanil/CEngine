...
// Visibility-buffer raster: draws surface + skinned IDs into one RG32_UINT target. Surface pixels
// shade directly from this buffer; skinned pixels are marked by bit7 for the skinned materialize pass.
